...
C.DateRange = React.createClass({
    render() {
        return (
            <div className="input-daterange input-group" style={{maxWidth: '400px'}}>
                <input type="text" className="form-control input-sm" value="" id="from" />
                <span className="input-group-addon">to</span>
                <input type="text" className="form-control input-sm" value="" id="to" />
            </div>
        );
    }
});
...
C.FormObject = React.createClass({
    ...
    createElems(elems) {
        console.log('createElems()', arguments);
